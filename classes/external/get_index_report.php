...
/**
 * External API: get time spent report rows.
 *
...
/**
 * Get paginated time spent report data.
 */
class get_index_report extends external_api {
    /**
     * Parameters.
     *
     ...
     * @return array
     */
    public static function execute(int $courseid, int $page = 1, int $perpage = 10, string $searchdata = ''): array {
        ...
        return local_timespent_get_index_report_data(
            $params['courseid'],
            $params['searchdata'],
            $params['page'],
            $params['perpage']
