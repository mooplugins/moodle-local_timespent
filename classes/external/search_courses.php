...
/**
 * External API: search courses for the time spent course report picker.
 *
...
/**
 * Search courses for report selection.
 */
class search_courses extends external_api {
    ...
    public static function execute_parameters(): external_function_parameters {
        return new external_function_parameters([
            'query' => new external_value(PARAM_TEXT, 'Course name or shortname search'),
    ...
    public static function execute(string $query, int $limit = 25): array {
        ...
        return [
            'courses' => local_timespent_search_report_courses($params['query'], $params['limit']),
        ];
    }
